package com.ttn.community.core.factory;
...
import com.ttn.community.core.models.JournalSocialComponent;
 ...
 */
@Component(name = "Social journal Component Factory",immediate=true)
//@Service
public class CustomJournalSocialComponentFactory extends JournalEntrySocialComponentFactory implements SocialComponentFactory{
