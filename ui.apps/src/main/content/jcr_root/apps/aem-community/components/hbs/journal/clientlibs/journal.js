...
(function($CQ, _, Backbone, SCF) {
    ...
    SCF.registerComponent('aem-community/components/hbs/comment', SCF.BlogPost, SCF.BlogPostView);
    SCF.registerComponent('aem-community/components/hbs/entry_topic', SCF.BlogTopic, SCF.BlogTopicView);
    SCF.registerComponent('aem-community/components/hbs/journal', SCF.Journal, SCF.JournalView);
})($CQ, _, Backbone, SCF);
